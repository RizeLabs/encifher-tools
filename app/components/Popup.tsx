  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-gradient-to-b from-[#361B8D] to-[#11016B] outline-none focus:outline-none h-[330px] items-center space-y-2">
            <Image
              src={"/tick-animation.gif"}
              alt=""
              width={200}
              height={200}
            />
